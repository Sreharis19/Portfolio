...
const ProjectsSection = ({ isDesktop }: IDesktop) => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      ...
      I have contributed to over 10+ projects, including high-performance web applications, FinTech platforms, e-commerce solutions, backend systems, and innovative UI/UX designs, leveraging technologies like MERN stack, AWS, and Python, alongside expertise in data management and open-source contributions
      </h2>
    </div>
  );
